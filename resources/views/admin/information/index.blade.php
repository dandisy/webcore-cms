...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Informasi</h1>
        <h1 class="pull-right">
            <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('information.create') !!}">Add New</a>
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('admin.information.table')
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form class="modal-content" action="{!! url('importInformation') !!}" method="post" enctype="multipart/form-data">
