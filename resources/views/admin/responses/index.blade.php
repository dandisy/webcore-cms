...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Tanggapan</h1>
        <h1 class="pull-right">
            <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('responses.create') !!}">Add New</a>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form class="modal-content" action="{!! url('importResponse') !!}" method="post" enctype="multipart/form-data">
